...
const ThemeSettings = () => {
  ...
  return (
    <div className="bg-half-transparent w-screen fixed nav-item top-0 right-0">
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:[#484B52] w-full md:w-400 dark:bg-main-dark-bg">
        ...
        <div className="flex-col border-t-1 border-color p-4 ml-4">
          ...
          <div className="flex gap-3">
            {themeColors.map((item, index) => (
                <div key={index} data-tip={item.name} className="relative mt-2 cursor-pointer flex gap-5 items-center px-1">
